...
import { ExchangeRate, conver/.˘˘tMonies } from './js/exchange.js';
...
async function makeApiCall(currencyFrom, currencyTo, currencyAmt) {
...
$(document).ready(function() {
  $('#exchange').click(function() {
    ...
    clearFields();
    makeApiCall(currencyFrom, currencyTo, currencyAmt);
    makeApiCall();
  })
